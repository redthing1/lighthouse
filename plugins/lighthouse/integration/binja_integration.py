    ...
    def get_context(self, dctx, startup=True):
        ...
        if dctx_id not in self.lighthouse_contexts:
            ...
            user_config = LighthouseUserConfig(
                block_trace_confidence_threshold=settings.get_double('lighthouse_binja.block_trace_confidence_threshold', resource=dctx),
                suspicious_nodes_confidence_threshold=settings.get_double('lighthouse_binja.suspicious_nodes_confidence_threshold', resource=dctx)
            )
